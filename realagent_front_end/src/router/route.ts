...
class PathBotShop extends BasePath {
  constructor() {
    super('botshop');
  }

  botStore = this.getPath('bot-store');
  payment = this.getPath('payment');
}
...
export const PATH_BotShop = new PathBotShop();
...
export const PUBLIC_ENDPOINTS = [PATH_PUBLIC.BotShop];
